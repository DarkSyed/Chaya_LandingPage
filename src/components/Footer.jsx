    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <a href="#" className="inline-block mb-4">
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-zLpYDWRjkGyz9oHR9RpH7dzSuLWcpu.png"
                alt="Chaya Logo"
                className="h-12 w-auto"
              />
            </a>
            <p className="text-gray-400 mb-4 max-w-md">
              Chaya helps restaurants and businesses automate inventory management, reduce waste, and increase
              profitability.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {new Date().getFullYear()} Chaya. All rights reserved.</p>
